...
int main()
{
    ...
    switch(respuesta2){
        ...
        do{
            ...
            cout << "B: " << B[0] << primero << ", " << B[1] << segundo << ", " << B[2] << tercero << endl << endl;

            cout << "i" << "   j   " << "k" << endl;
            cout << A[0] << "   " << A[1] << "   " << A[2] << endl;
            cout << B[0] << "   " << B[1] << "   " << B[2] << endl << endl;

            cout << A[1] << "  " << A[2] << "  " << A[0] << "  " << A[2] << "  " << A[0] << "  " << A[1] << endl;
            cout << "     i-" << "     j+" << "       k" << endl;
            cout << B[1] << "  " << B[2] << "  " << B[0] << "  " << B[2] << "  " << B[0] << "  " << B[1] << endl;
        ...
        do{
            ...
            resultado[0] = 1 *(B[0] - A[0]);
            resultado[1] = 1 *(B[1] - A[1]);
            resultado[2] = 1 *(B[2] - A[2]);

            cout << "\n(" << B[0] << " - " << A[0]<< ")" << primero << " + " << "(" << B[1] << " - " << A[1] << ")" << segundo << " + " << "(" << B[2] << " - " << A[2] << ")" << tercero << endl;
            cout << "\nEcuacion vectorial: " << resultado[0] << primero  << " + " << resultado[1] << segundo <<  " + " << resultado[2] << tercero << endl;
            cout << "\nEcuaciones parametricas" << endl;
            cout << "X = " << A[0] << " + " << resultado[0] << "t" << endl;
            cout << "Y = " << A[1] << " + " << resultado[1] << "t" << endl;
            cout << "Z = " << A[2] << " + " << resultado[2] << "t" << endl;
